...
- [x] T001 Add `InputCount` (default 2, `[Range(1, 10_000)]`) and `OutputCount` (default 1, `[Range(1, 10_000)]`) properties to `NeatSharpOptions` in `src/NeatSharp/Configuration/NeatSharpOptions.cs`. Add corresponding validation tests to `tests/NeatSharp.Tests/Configuration/NeatSharpOptionsTests.cs`.
