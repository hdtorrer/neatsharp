...
// This file defines the user-facing interface for batch evaluation.
...
///
/// The <paramref name="setFitness"/> callback must be invoked
/// exactly once for each index in <paramref name="genomes"/>.
